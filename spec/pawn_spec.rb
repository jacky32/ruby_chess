...
describe Pawn do
  ...
  describe '#move' do # move movement methods to game to avoid ObjectSpace(board)?
    context 'white piece' do
      context 'starting in b2' do
        ...
        it 'moves to b3' do
          ...
          pawn.move(@start_coordinate, end_coordinate)
        ...
        it "moves to b3 but doesn't move to b5 afterwards" do
          end_id_y = 6
          end_id_x = 2
          end_coordinate = create_coordinate(end_id_y, end_id_x)
          ...
          pawn.move(end_coordinate, final_coordinate)
